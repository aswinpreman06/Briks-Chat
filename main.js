...
class MessageWidget {
  ...
  async initialize() {
    ...
    function handleClick() {
      ...
      document.getElementById('cont').innerHTML= document.getElementById('subject').value
    }
  ...
  createWidgetContent() {
    this.widgetContainer.innerHTML = `
       ...
       <form>
            ...
            <div class="user-qs">
            <p>Can you give me lists of products available?</p> 
            </div>
         
      
            <div class="form__field">
              <p>Absolutely! Please tell me what you're looking for, and I'll try to find the best matching products from our collection.
              Let's do it! 👍</p>
            </div>
            <div class="user-qs">
            <p>Thank You</p> 
       ...
       class='send send-input'
     />
       <button class='send send-btn' id="myButton">Send</button>
       </div>
